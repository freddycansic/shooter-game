use crate::collision::collidable::{Intersectable, RayHit, RayHitNode, SweepHit, SweepHitNode};
...
impl Physics {
    ...
    pub fn sweep_intersect_sphere(
        ...
        self.colliders
            ...
            .min_by(|(a, _, _, _), (b, _, _, _)| a.t.partial_cmp(&b.t).unwrap())
            .map(|(local_hit, local_velocity, node, node_index)| {
