...
mod tests {
    ...
    fn intersect_triangle_perpendicular() {
        ...
        let result = triangle.narrow_intersect(&ray, &Assets::new()).unwrap();
    ...
    fn sweep_intersect_sphere_perpendicular_face_direct() {
        ...
        let result = triangle.narrow_intersect(&sweep, &Assets::new()).unwrap();
    ...
    fn sweep_intersect_sphere_vertex_miss() {
        ...
        let result = triangle.narrow_intersect(&sweep, &Assets::new());
